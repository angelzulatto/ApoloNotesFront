...
export const Tags = () => {
  ...
  const startEdit = (id: number, nombreTag: string) => {
    setEditingId(id);
    setValue("nombreTag", nombreTag);
  };
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-gray-600">
            Manage your tags for organizing notes and events
          </p>
        </div>
                ...
                >
                  {editingId === tag.id ? (
                    ...
                    >
                      <div className="flex-1">
                        <input
                          {...registerEdit("nombreTag")}
                          type="text"
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                        />
                        {editErrors.nombreTag && (
                          <p className="text-red-600 text-sm mt-1">
                            {editErrors.nombreTag.message}
                          </p>
                        )}
                      </div>
                      <button
                    ...
                    <>
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() => startEdit(tag.id, tag.nombreTag)}
